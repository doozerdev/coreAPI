...
class Doozer
  ...
  def getLists (session_id)
    ...
    parseResponse(self.class.post( '/api/items/index', options ))
  end
  ...
  def getChildren (session_id, item_id)
    ...
    parseResponse(self.class.post( "/api/items/#{item_id}/children", options ))
  end
  ...
  def getItem (session_id, item_id)
    ...
    parseResponse(self.class.post( "/api/items/#{item_id}/show", options))
  end
